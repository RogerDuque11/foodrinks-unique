...
const RenderItemOrder = ({ props }) => {
    ...
    //const values = ['PENDING', 'CONFIRMED', 'PREPARING', 'TERMINATED', 'DISPATCHED', 'DELIVERED', 'FINISHED', 'CANCELED' ]
    ...
    return (
        ...
        <ListItem  
            ...
            <View style={[ styles.column, styles.flex ]}>
                ...
                <View style={[ styles.row, styles.paddingTiny, styles.alignCenter, styles.border_B ]}>
                    ...
                    <View style={[ styles.flex, styles.marginTiny_X ]}>
                        <View style={[ styles.row, styles.justifyBetween, styles.alignCenter]}>
                            <Text style={[ styles.textSmall, styles.textBold, styles.uppercase, styles.flex, {color: color} ]}>{trans(item.type)}</Text>
                        ...
                        <View style={[styles.row, styles.justifyBetween ]}>
                            <Text style={[ styles.textSmall ]}>{item.customer}</Text>
                            <Text style={[ styles.textSmall ]}>{item.hour}</Text> 
                        </View>
                    </View>
                </View>
                ...
                <TouchableOpacity style={[ styles.paddingTiny_Y ]} onPress={()=>setVisible(true)}  activeOpacity={.6} >
                    ...
                    <View style={[ styles.row, styles.justifyBetween, styles.borderTop, styles.paddingTiny_T ]}>
        ...
        <ShowOrder props={{order:item, visible, setVisible, callbackItem }}/>
        </>
    )
}
